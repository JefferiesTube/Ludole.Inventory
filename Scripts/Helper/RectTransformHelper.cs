...
namespace Ludole.Inventory
{
    ...
    {
        public static RectTransform SetAnchor(this RectTransform source, AnchorPresets allign, int offsetX = 0,
            int offsetY = 0)
        {
            ...
            switch (allign)
            {
                ...
                default:
                    throw new ArgumentOutOfRangeException(nameof(allign), allign, null);
            }
